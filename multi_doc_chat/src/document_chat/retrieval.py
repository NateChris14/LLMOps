...
class ConversationalRAG:
    ...
    def load_retriever_from_faiss(
        ...
        try:
            ...
            log.error("Failed to load FAISS retriever from FAISS", error=str(e))
    ...
    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        ...
        try:
            ...
            if not answer:
                log.warning(
                    "No answer generated", user_input=user_input,
                    session_id=self.session_id
                )
    ...
    def _build_lcel_chain(self):
        try:
            ...
            # 1.Rewriting the user question with chat history context
            question_rewriter = (
            ...
            # 2. Retrieving docs for rewritten question
